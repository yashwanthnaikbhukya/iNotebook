                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        {!localStorage.getItem('token') ? 
                            <div className="d-flex">
                                <Link className="btn btn-primary mx-1 custom-btn" to="/login" role="button">Login</Link>
                                <Link className="btn btn-primary mx-1 custom-btn" to="/signup" role="button">Signup</Link>
                            </div> 
